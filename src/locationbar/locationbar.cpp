...
LocationBar::LocationBar(QWidget *parent)
    : LineEdit(parent), m_webView(0), m_siteIcon(0), m_privacyIndicator(0) {
  ...
  connect(this, SIGNAL(textChanged(const QString &)), m_clearButton,
...
WebView *LocationBar::webView() const { return m_webView; }
